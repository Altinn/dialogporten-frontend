...
envsubst '$APPLICATION_INSIGHTS_INSTRUMENTATION_KEY $APPLICATION_INSIGHTS_DISABLE_DEPENDENCY_TRACKING $DIALOGPORTEN_STREAM_URL' < /usr/share/nginx/html/index.html > /usr/share/nginx/html/index_temp.html
