  ...
  },
  {
    ...
    content: {
      ...
      summary: {
        ...
        value: [
          {
            value: 'Main Message for Testbedrift AS',
            languageCode: 'nb',
          },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ...
      summary: {
        ...
        value: [
          {
            value: 'Main Message for Firma AS',
            languageCode: 'nb',
          },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ...
      summary: {
        ...
        value: [
          {
            value: 'Sub message for Testbedrift AS',
            languageCode: 'nb',
          },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ...
      summary: {
        ...
        value: [
          {
            value: 'MyCompany AS main. Sub company name is same as main company name',
            languageCode: 'nb',
          },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ...
      summary: {
        ...
        value: [
          {
            value: 'MyCompany AS sub, name different.',
            languageCode: 'nb',
          },
        ],
      },
