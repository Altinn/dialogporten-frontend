...
import { useProfileSettingsOnboarding } from '../../../onboardingTour/useProfileSettingsOnboarding';
...
export const Settings = () => {
  ...
  useProfileSettingsOnboarding({ isLoading: isLoadingUser && isLoadingParties });
