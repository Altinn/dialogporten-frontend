    ...
    if (collapseGroups) {
      ...
      for (const item of regularDialogs) {
        ...
        if (allWithinSameYear) {
          ...
          groupKey = format(updatedAt, 'yyyy');
        }
        ...
        if (existingGroup) {
          ...
          const orderIndex = allWithinSameYear ? updatedAt.getMonth() : updatedAt.getFullYear();
          const newGroup = { id: groupKey, title: groupKey, description: '', items: [item], orderIndex };
