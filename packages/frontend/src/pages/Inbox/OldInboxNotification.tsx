...
export const OldInboxNotification = () => {
  ...
  const mostRecentMessage = altinn2messages.reduce((latest: Altinn2Message | null, message: Altinn2Message | null) => {
    if (!message?.LastChangedDateTime || !latest?.LastChangedDateTime) return latest;
