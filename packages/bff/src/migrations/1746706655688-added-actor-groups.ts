...
export class AddedActorGroups1746706655688 implements MigrationInterface {
  name = 'AddedActorGroups1746706655688';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "party" ("id" integer NOT NULL, CONSTRAINT "PK_e6189b3d533e140bb33a6d2cec1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "group_parties_party" ("groupId" integer NOT NULL, "partyId" integer NOT NULL, CONSTRAINT "PK_c8c033661ef90031d66453cfc9b" PRIMARY KEY ("groupId", "partyId"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "group_parties_party" ADD CONSTRAINT "FK_3d02ba95297556543b830d9c5e3" FOREIGN KEY ("partyId") REFERENCES "party"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
